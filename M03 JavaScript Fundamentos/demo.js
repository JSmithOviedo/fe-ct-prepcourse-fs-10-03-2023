// Permite hacer comentario en un línea
/*
Permite hacer comentarios en bloque de texto
*/
...
//? Tipos de Datos
//* Strings -> es una cadena de texto que va entre comillas
// "Hola, como estas"
//* Number -> -2, 5,
var numero = 6;
//* Boolean -> true, false
...
console.log(colegio); para imprimir un mensaje
//* Null
var filaDelBanco = null; para definir algo vacio o sin valor
...
//? Operadores
//* Aritmeticos - > + - / * % **
// () ** / * + - orden en resolver una operación
//* De comparacion >= > >= < <= == ===
// 6>8 -> false
// 6>=6 -> true
...
//? Metodos
var saludo = "hola";
// saludo.length -> 4 Permite conocer la cantidad de caracteres de un spring
var numero = 5; // -> "5"
// numero.toString()
...
// Permite definir logica si, entonces...
...
//? Math
// math.ceil(5.6) -> 6 Permite redondear un valor hacia arriba
// math.floor(5.6) -> 5 Permite redondear un valor hacia abajo
